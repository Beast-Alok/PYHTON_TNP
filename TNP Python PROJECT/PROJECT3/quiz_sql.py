...
Additionally, the application store the user's data in a MySQL database, including user information, quiz results, and quiz questions. The application also allows users to view their quiz results, view and edit their profile information, change their password, and delete their account.
